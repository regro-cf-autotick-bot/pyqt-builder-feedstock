...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyqt-builder-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15394&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyqt-builder-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyqt-builder` can be installed with:

```
conda install pyqt-builder
```

It is possible to list all of the versions of `pyqt-builder` available on your platform with:
